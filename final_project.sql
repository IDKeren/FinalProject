...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 09, 2024 at 06:49 PM
...
DROP TABLE IF EXISTS permanent_obstacles;
...
(1, 9, 5, 2, 0, 0, 1725899216),
(2, 11, 3, 4, 0, 0, 1725916708),
(3, 12, 1, 3, 0, 0, 1725916726),
(4, 17, 4, 5, 0, 0, 1725916737),
(5, 16, 1, 4, 0, 0, 1725916744),
(6, 22, 2, 5, 0, 0, 1725916751);
...
CREATE TABLE `drones` (
  ...
  `is_detouring` tinyint DEFAULT 0,
...
(23, 88, 0, 0, 0, 192, 139.8, 40, 192, 139.8, -1, 0, 0, 0, NULL, NULL, 4, 1, 0);
...
CREATE TABLE `permanent_obstacles` (
  `id` int(11) NOT NULL,
  `x_min` double DEFAULT NULL,
  `x_max` double DEFAULT NULL,
  `y_min` double DEFAULT NULL,
...
INSERT INTO `permanent_obstacles` (`id`, `x_min`, `x_max`, `y_min`, `y_max`, `z_min`, `z_max`, `t_start`, `t_end`, `value`) VALUES
...
-- INSERT INTO `steps` (`id`, `step_index`, `drone_x_coordinate`, `drone_y_coordinate`, `drone_z_coordinate`, `drone_id`) VALUES
-- (1, 0, 46.1, 136.2, 76, 9),
-- (2, 1, 44.931, 138.688, 66.3854, 9),
-- (3, 2, 38.308, 146.099, 65.2787, 9),
-- (4, 3, 35.3418, 155.584, 66.3864, 9),
-- (5, 4, 27.1966, 161.096, 68.1958, 9),
-- (6, 5, 18.1305, 160.96, 63.9783, 9),
-- (7, 6, 13.1673, 169.56, 65.1667, 9),
-- (8, 7, 5.12307, 175.065, 67.3998, 9),
-- (9, 8, 7.6, 181.9, 67.3998, 9),
-- (10, 0, 128.9, 16.6, 65, 11),
-- (11, 1, 123.443, 23.5196, 69.7271, 11),
-- (12, 2, 120.101, 30.68, 75.8557, 11),
-- (13, 3, 114.77, 39.0871, 74.9101, 11),
-- (14, 4, 108.868, 36.835, 82.6623, 11),
-- (15, 5, 104.786, 28.5289, 86.4503, 11),
-- (16, 6, 101.47, 25.0261, 95.2102, 11),
-- (17, 7, 99.4637, 18.8633, 102.826, 11),
-- (18, 8, 99.1566, 20.4738, 112.69, 11),
-- (19, 9, 98.1315, 17.0559, 122.032, 11),
-- (20, 10, 88.6379, 14.2363, 120.646, 11),
-- (21, 11, 82.7607, 11.8185, 112.925, 11),
-- (22, 12, 75.7, 15.6, 112.925, 11),
-- (23, 0, 98.7, 92.5, 128, 12),
-- (24, 1, 88.8077, 91.0903, 128.395, 12),
-- (25, 2, 81.6548, 97.6868, 130.702, 12),
-- (26, 3, 76.9925, 92.1553, 137.606, 12),
-- (27, 4, 78.3461, 84.5894, 141.25, 12),
-- (28, 5, 82, 70.1, 141.25, 12),
-- (29, 0, 98.7, 92.5, 36, 17),
-- (30, 1, 105.618, 98.8025, 39.5246, 17),
-- (31, 2, 106.059, 102.91, 48.6314, 17),
-- (32, 3, 109.641, 98.4135, 56.814, 17),
-- (33, 4, 109.866, 92.4405, 64.831, 17),
-- (34, 5, 109.394, 90.2739, 74.582, 17),
-- (35, 6, 115.56, 83.118, 77.8635, 17),
-- (36, 7, 122.338, 89.898, 80.7074, 17),
-- (37, 8, 126.223, 85.8255, 88.9734, 17),
-- (38, 9, 129.005, 94.7178, 92.6043, 17),
-- (39, 10, 133.113, 103.002, 96.4135, 17),
-- (40, 11, 133.841, 111.613, 101.445, 17),
-- (41, 12, 139.9, 106.2, 101.445, 17),
-- (42, 0, 128.9, 16.6, 54, 16),
-- (43, 1, 120.783, 17.3495, 59.7929, 16),
-- (44, 2, 120.409, 25.6451, 65.3645, 16),
-- (45, 3, 121.002, 33.5703, 71.4341, 16),
-- (46, 4, 113.008, 38.0268, 67.4053, 16),
-- (47, 5, 103.381, 35.331, 67.1932, 16),
-- (48, 6, 94.0426, 31.8335, 67.9457, 16),
-- (49, 7, 86.6251, 27.1405, 72.7369, 16),
-- (50, 8, 79.8931, 21.7029, 77.7482, 16),
-- (51, 9, 79.4455, 22.6969, 79.3657, 16),
-- (52, 10, 75.7, 15.6, 79.3657, 16),
-- (53, 0, 98.7, 92.5, 109, 22),
-- (54, 1, 102.191, 101.749, 110.509, 22),
-- (55, 2, 106.799, 109.68, 114.49, 22),
-- (56, 3, 115.904, 111.875, 117.994, 22),
-- (57, 4, 121.76, 117.998, 123.306, 22),
-- (58, 5, 131.3, 117.829, 120.313, 22),
-- (59, 6, 132.872, 116.494, 130.098, 22),
-- (60, 7, 139.9, 106.2, 130.098, 22);
...
ALTER TABLE `logs` MODIFY timestamp DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6);
...
INSERT INTO `drones` (`battery_percentage`, `is_fault`, `is_detouring`, `velocity`, `drone_x_coordinate`, `drone_y_coordinate`, `drone_z_coordinate`, `real_x`, `real_y`, `real_z`, `is_package_load`, `is_package_unload`, `last_communication`, `planned_start_time`, `step_index`, `base_id`, `ready_for_delivery`, `last_moved`) VALUES
(86, 0, 0, 4, 327, 280.7, -1, 327, 280.7, -1, 0, 0, 0, NULL, NULL, 5, 1, 0),
(86, 0, 0, 4, 327, 280.7, -1, 327, 280.7, -1, 0, 0, 0, NULL, NULL, 5, 1, 0),
(86, 0, 0, 4, 327, 280.7, -1, 327, 280.7, -1, 0, 0, 0, NULL, NULL, 5, 1, 0),
(86, 0, 0, 4, 327, 280.7, -1, 327, 280.7, -1, 0, 0, 0, NULL, NULL, 5, 1, 0),
(86, 0, 0, 4, 327, 280.7, -1, 327, 280.7, -1, 0, 0, 0, NULL, NULL, 5, 1, 0),
